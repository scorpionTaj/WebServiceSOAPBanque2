 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://service.ma/", wsdlLocation = "http://localhost:8080/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://service.ma/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://service.ma/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ma/", "BanqueServicePort"), BanqueService.class, features);
    }
